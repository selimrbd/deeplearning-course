...
class MLP:
    ...
    def initialize_params(self, layer_dims: list[int]):
        """
        Arguments:
    ...
    def linear_activation_forward(self, A_prev, W, b, activation):
        ...
        if activation == "sigmoid":
            ...
            Z, linear_cache = self.linear_forward(
                A_prev, W, b
            )  # This "linear_cache" contains (A_prev, W, b)
            A, activation_cache = self.sigmoid(
                Z
    ...
    def L_layer_model(
        ...
        ### START CODE HERE ###
        parameters = self.initialize_params(layers_dims)
        ### END CODE HERE ###
